...
$result = mysql_query("SELECT * FROM ecrm_comentarios_v WHERE usuario = '$usuario' AND fechaproxima = '$fecha_actual' AND horaasignacion != 'ok' AND (estadodeventa != 'facturado y clonado') ORDER BY fechaproxima desc limit 1000");
