							...
							<tr>
								...
								<td width="60%">
									...
									<table class="table table-bordered table-striped table-condensed table-hover" style="width:100%; margin-bottom:0;">
										<tr>
											<th class=""><span class="label label-success"><?php semaforoHoy($usuariosEquipo[$i],'0') ?></span></th><td>Hoy</td>
										</tr>
										<tr>
											<th class=""><span class="label label-danger"><?php semaforoAtrasados($usuariosEquipo[$i],'0') ?></span></th><td>Atrasados</td>
										</tr>
									</table>
								</td>
							</tr>
			...
			<div class="col-lg-9 col-md-9 col-sm-9">
				<table class="table table-bordered table-striped table-condensed table-hover">
					...
					<tr>
						...
						<td><?php semaforoHoy($usuariosEquipo[$i],'1') ?></td>
						<td><?php semaforoAsignaciones($usuariosEquipo[$i],'1') ?></td>
						<td><?php semaforoAtrasados($usuariosEquipo[$i],'1') ?></td>
					</tr>
					...
					<tr>
						<th>Total</th>
						<td><?php semaforoHoy($usuariosEquipo[$i],'0') ?></td>
						<td><?php semaforoAsignaciones($usuariosEquipo[$i],'0') ?></td>
						<td>
