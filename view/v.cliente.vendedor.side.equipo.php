<div class="row">
	<div class="col-xs-9">
		<ul class="nav nav-tabs" role="tablist">
			...
			<li><a href="#pr2" role="tab" data-toggle="tab">2014</a></li>
			<li><a href="#pr3" role="tab" data-toggle="tab">2015</a></li>
			<li><a href="#pr5" role="tab" data-toggle="tab">2016</a></li>
			<li><a href="#pr4" role="tab" data-toggle="tab">Plantillas</a></li>
		</ul>
		<div class="tab-content">
			<div class="tab-pane active" id="pr1">
				<?php include('view/v.cliente.vendedor.side.equipo.historial.php') ?>
			</div>
			...
			<div class="tab-pane" id="pr4">
				<?php include('view/v.cliente.vendedor.side.plantilla.php') ?>
			</div>
			<div class="tab-pane" id="pr5">
				<div class="panel-group" id="accordion16">
					<div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion16" href="#collapse1601">Enero</a></h4></div><div id="collapse1601" class="panel-collapse collapse"><?php include('inc/calendar.1601.php') ?></div></div>
					<div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion16" href="#collapse1602">Febrero</a></h4></div><div id="collapse1602" class="panel-collapse collapse"><?php include('inc/calendar.1602.php') ?></div></div>
					<div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion16" href="#collapse1603">Marzo</a></h4></div><div id="collapse1603" class="panel-collapse collapse"><?php include('inc/calendar.1603.php') ?></div></div>
					<div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion16" href="#collapse1604">Abril</a></h4></div><div id="collapse1604" class="panel-collapse collapse"><?php include('inc/calendar.1604.php') ?></div></div>
					<div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion16" href="#collapse1605">Mayo</a></h4></div><div id="collapse1605" class="panel-collapse collapse"><?php include('inc/calendar.1605.php') ?></div></div>
					<div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion16" href="#collapse1606">Junio</a></h4></div><div id="collapse1606" class="panel-collapse collapse"><?php include('inc/calendar.1606.php') ?></div></div>
					<div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion16" href="#collapse1607">Julio</a></h4></div><div id="collapse1607" class="panel-collapse collapse"><?php include('inc/calendar.1607.php') ?></div></div>
					<div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion16" href="#collapse1608">Agosto</a></h4></div><div id="collapse1608" class="panel-collapse collapse"><?php include('inc/calendar.1608.php') ?></div></div>
					<div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion16" href="#collapse1609">Septiembre</a></h4></div><div id="collapse1609" class="panel-collapse collapse"><?php include('inc/calendar.1609.php') ?></div></div>
					<div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion16" href="#collapse1610">Octubre</a></h4></div><div id="collapse1610" class="panel-collapse collapse"><?php include('inc/calendar.1610.php') ?></div></div>
					<div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion16" href="#collapse1611">Noviembre</a></h4></div><div id="collapse1611" class="panel-collapse collapse"><?php include('inc/calendar.1611.php') ?></div></div>
					<div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion16" href="#collapse1612">Diciembre</a></h4></div><div id="collapse1612" class="panel-collapse collapse"><?php include('inc/calendar.1612.php') ?></div></div>
				</div>
			</div>
		</div> 
	</div>
