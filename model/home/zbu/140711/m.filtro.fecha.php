...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title">
			Filtrar pors Fecha de Contacto: <!-- Desde <?= $fecha_inicio_filtro_mx ?> Hasta <?= $fecha_fin_filtro_mx ?> -->
		</h3>
	</div>
...
?>
		...
		<td>a
			<form action="controller/c.filtro.fecha-reset.php" method="post">
				<?php
				echo '_'.$fecha_inicio_filtro.'_';
					if ($fecha_inicio_filtro == '--') {
				
					}
					else {
?>
					<input type="submit" value="sQuitar Filtro" class="form-control btn btn-default btn-xs" />
<?php
					}
# $fecha_inicio_filtro --
# $fecha_fin_filtro--					
