...
<?php
  ...
  $result = mysql_query("SELECT * FROM formrecomiendaygana ORDER BY idformrecomiendaygana desc limit $start,$per_page");
...
# Informacion de la tabla de Comentarios para buscar el estado de la venta y la fecha proxima
            ...
            if ($asignadoa == '') {
              echo '<b>Asignado a: </b>Sin Asignación<br />';
            }
            else {
              echo '<b>Asignado a: </b>'.$asignadoa.'<br />';
            }
