...
if (isset($_POST["estadodeventa"])) {
	...
	#$sql2 = "UPDATE `jcnoble`.`ecrm_comentarios_v` SET `horarespuesta`='12:00 pm' WHERE `horarespuesta`='7:46 pm';";
	...
	if ($fechaproximaValidator < $fecharespuestaValidator) {
		...
		# $_SESSION["test150521"] = "<script>alert('prueba1');</script>";

	}

	else {
		# $_SESSION["test150521"] = "<script>alert('prueba2');</script>";
		if ($_POST["estadodeventa"] == 'seguimiento') {
			mysql_query($sql, $conexion);
	...
	# $para = "$fcasignadoa@avanceytec.com.mx, $usuario@avanceytec.com.mx";
	if ($usuario == 'amariscal') {
		$para = "$usuario@avanceytec.com.mx";
	}
	else {
		$para = "$fcasignadoa@avanceytec.com.mx, $usuario@avanceytec.com.mx";
	}
...
/**/
	...
	if ($_SESSION["formularioRYG"] == 'RYG') {
		...
		if ($fcasignadoa == '') {
			$para = "$usuario@avanceytec.com.mx, $usuarioRYG@avanceytec.com.mx";
		}
		else {
			$para = "$fcasignadoa@avanceytec.com.mx, $usuario@avanceytec.com.mx, $usuarioRYG@avanceytec.com.mx";
		}
	}
	else {
