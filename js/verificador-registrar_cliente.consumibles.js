...
function validaCampos(registrar_cliente){
	...
	else if(vacio(registrar_cliente.pais.value))
	alert("El campo pais no puede estar vacio");

	else if(vacio(registrar_cliente.email.value))
	alert("El campo email no puede estar vacio");

	else if(vacio(registrar_cliente.equipo.value))
	alert("El campo producto no puede estar vacio");

	else if(vacio(registrar_cliente.giro.value))
	alert("El campo giro no puede estar vacio");
