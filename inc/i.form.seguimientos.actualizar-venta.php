...
<form method="post" id="form1" action="seguimientos.actualizar-venta.php" onSubmit="return validaCampos(this)" class="contacto" style="margin-top:-40px;">
	...
	<input class="campos" type="hidden" name="idedit" readonly="readonly" value="<?php echo $_GET["id"]?>">
...
<table width="500" cellpadding="0" border="0">
	<tr>
		<td style="width:50%;">
			<label><?php echo "$obl";?>Próxima llamada el_:</label>
		</td>
		<td style="width:45%;">
...
<?php
	...
	if ($termometro == 'azul') {
?>
<input type="hidden" value="facturado" name="estadodeventa" />
<input type="hidden" value="" name="fechadia" />
<input type="hidden" value="" name="fechames" />
<input type="hidden" value="" name="fechaano" />
<input type="hidden" value="" name="numerodefactura" />
