...
<form method="post" id="form1" action="seguimientos.php?pos=<?= $pos ?>" onSubmit="return validaCampos(this)" class="contacto">
...
<table cellpadding="1" cellspacing="2" border="0">
	<tr>
		<td>
			<select name="usuario" class="usuario" style="width:100%;" onchange="this.form.submit()">
				<option value=""></option>
